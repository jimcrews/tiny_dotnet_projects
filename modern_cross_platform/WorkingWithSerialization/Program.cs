...
using WorkingWithSerialization.lib; // Person 
...
namespace WorkingWithSerialization
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            // useXml(people);
            // useJson(people);
            await openJson(); // requires to be in async Task method.
        }

        static void useJson(List<Person> people)
        {
        ...
        static void useXml(List<Person> people)
        {
        ...
        static void openXml(string path)
        {
            var xs = new XmlSerializer(typeof(List<Person>));
